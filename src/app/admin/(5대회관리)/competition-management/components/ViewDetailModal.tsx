        ...
        <div className='flex flex-col space-y-[10px]'>
            <div className='flex justify-between items-center p-[10px] border-b-1 border-[#DCDCDC]'>
                <div className='flex flex-col gap-[4px]'>
                    <p className='text-[#404040] font-semibold text-[18px]'>이재은</p>
            ...
            <div className='flex justify-between items-center p-[10px] border-b-1 border-[#DCDCDC]'>
                <div className='flex flex-col gap-[4px]'>
                    <p className='text-[#404040] font-semibold text-[18px]'>Lucy Brown</p>
            ...
            <div className='flex justify-between items-center p-[10px]'>
                <div className='flex flex-col gap-[4px]'>
                    <p className='text-[#404040] font-semibold text-[18px]'>Mia Scott</p>
