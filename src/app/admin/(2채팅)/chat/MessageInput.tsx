...
import { ImageIcon, Monitor, Video } from "lucide-react"; // Using Lucide icons
  ...
  return (
    <div className="border-t bg-[#ffffff] pb-12 pt-3 px-4">
      <div className="flex items-center p-3">
        ...
        <Dropdown>
          <DropdownTrigger>
            <div className="flex items-center gap-2 cursor-pointer bg-[#F5F5F5] py-3 px-6 rounded-r-2xl">
