  ...
  return (
    <div className="w-full max-w-md overflow-hidden">
      ...
      <div className="flex gap-3 my-5">
        <div className="bg-white cursor-pointer flex-1 px-2 py-3 rounded-lg flex justify-center items-center">
      ...
      <textarea
        ...
        defaultValue="운동 중 엉덩이 만이 아래서 움직임을 멈추어지지 못했어요. 네비부터는 다시철저히 할꺼요"
        className="bg-white resize-y min-h-[70px] w-full rounded-xl p-3 focus:outline-none"
      />
