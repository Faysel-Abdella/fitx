    ...
    <div className="flex flex-col gap-[30px] border-1 border-[#DCDCDC] bg-white rounded-[10px] px-[18px] pt-[18px] pb-[43px]">
      ...
      <div className="flex flex-col gap-[15px]">
        <div className="flex gap-[16px]">
          <div className="flex justify-center w-[149px] h-[159px] bg-[#DCDCDC61] border-1 border-[#EEEEEE] rounded-[13px] pt-[13px]">
          ...
          <div className="flex justify-center w-[149px] h-[159px] bg-black border-1 border-[#EEEEEE] rounded-[13px] pt-[13px]">
            <div className="flex flex-col items-center">
